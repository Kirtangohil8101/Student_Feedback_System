...
?>
       ...
       <div class="row">
                ...
                <form name="sentMessage" method="post" id="contactForm" novalidate>
                  <?php echo @$err; ?>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Message:</label>
                            <textarea rows="5" name="msg" cols="100" class="form-control" id="message" required data-validation-required-message="Please enter your message" maxlength="999" style="resize:none"></textarea>
                        </div>
                    </div>
                    <div id="success"></div>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Charusat University<br> Changa, Gujarat <br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (123) 456-7890</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="#">19dit019@charusat.edu.in</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Sunday: 9:00 AM to 4:00 PM</p>
            ...
            <span style="margin-bottom:-500px; margin-left:800px">
				<img src="last.jpg" alt="B" width="400px" height="300px">
            </span>
        </div>
